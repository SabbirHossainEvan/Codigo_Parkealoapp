...
function BottomNav({ active, onChange, unreadMessages = 0 }) {
  const tabs = [
    ...
    { id: "reservations", label: "Bookingtions" },
...
function MapScreen({ onSelect, favorites = [], onToggleFav }) {
  ...
  const [rentalMode, setRentlMode] = useState("hora");
        ...
        {showSearch && (
          ...
          >
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "14px 16px" }}>
              {/* ── Parkings cercanos al destino seleccionado ── */}
              {selectedDest && (
                <div>
                  <div
                    style={{
            ...
            {showSort && (
              ...
              >
                {[
                  ...
                  ["price_asc", "Price: menor"],
                  ["price_desc", "Price: mayor"],
    ...
    >
      <div style={{ flex: 1, overflowY: "auto", paddingBottom: 8 }}>
        ...
        <div style={{ padding: "18px 16px 0" }}>
          ...
          <div style={{ marginBottom: 14 }}>
            <SectionLabel>Services disponibles</SectionLabel>
          ...
          <div style={{ marginBottom: 4 }}>
            <Toggle
              ...
              sub="Enter the license plate of the vehicle to park."
            />
            {forOther && (
          ...
          <div style={{ marginBottom: 4 }}>
            <Toggle
              ...
              sub={
                <span>
                  Protegido con <strong>Insurances Bookingtions</strong> · Cubre hasta
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            {[
              ...
              ...(insurance ? [["Insurance Bookingtions", `${spot.currency}25`]] : []),
      ...
      >
        ...
        >
          ...
          >
            {spot.type === "private" ? "Request" : "Book"}
          </Btn>
        </div>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "14px 16px" }}>
        ...
        >
          {[
            { id: "card", label: "Credit card / débito" },
            { id: "cash", label: "Cash al llegar" },
          ].map((m) => (
            <button
              key={m.id}
    ...
    >
      ...
      >
        ...
        <div style={{ padding: "18px 20px 32px" }}>
          ...
          >
            {[
              [`Booking (${reservedHours}h)`, `RD$${subtotal}`],
              ...(overtimeMins > 0
...
function OccupiedSpaceModal({ reservation, pricePerHour, onClose, onCheckin }) {
  ...
  useEffect(() => {
    const t = setTimeout(() => {
      setStep(Math.random() > 0.3 ? "activeBookingtion" : "noBookingtion");
    }, 1800);
    return () => clearTimeout(t);
  }, []);
      ...
      if (isPublic) {
        ...
        if (hasSpaceSame) {
          setDiff({
            ...
            distance: null,
            priceDiff: 0,
            amenities: ["Covered", "Cameras", "24/7"],
          ...
          setDiff({
            type: "nearbyParking",
            newSpace: "A3",
            newParking: "Parking Bella Vista",
            address: "Av. Sarasota 65, Bella Vista",
            lat: 18.471,
            lng: -69.928,
            distance: "0.4 km",
            priceDiff: -20,
            amenities: ["Covered", "Cameras", "Personl"],
            note: "Parking lleno — te asignamos uno cercano disponible",
          });
        }
      } else {
        ...
        setDiff({
          type: "nearbyParking",
          newSpace: "A2",
          newParking: "Parking Naco Center",
          address: "Av. Lope de Vega 95, Naco",
          lat: 18.4762,
          lng: -69.9354,
          distance: "0.3 km",
          priceDiff: -30,
          amenities: ["Cameras", "Ctrl. acceso"],
          note: "Parking cercano en el área — disponible now",
        });
      }
      setStep("reassigned");
    }, 1500);
            ...
            >
              ...
              <div>
                <div style={{ fontWeight: 900, fontSize: 16, color: T.warn }}>
                  Booking activa en este espacio
                </div>
...
// ─── LIVE TIMER CARD ───────────────────────────────────────────────────────────
function ActiveBookingtionCard({ reservation, onCheckOut }) {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      from: "host",
      text: "¡Hola! Tu reserva está confirmada. El acceso es por la entrada lateral en la Street Las Damas.",
      time: "10:05 AM",
    },
    {
      id: 2,
        ...
        {tab === "active" &&
          (activeItems.length === 0 ? (
            <div style={{ textAlign: "center", padding: "50px 20px" }}>
              ...
              <div style={{ color: T.textSub, fontSize: 13 }}>
                Tus estadías completadas aparecerán en History.
              </div>
            </div>
          ) : (
            activeItems.map((r) => (
                ...
                <div style={{ padding: 14 }}>
                  ...
                  >
                    {r.status === "pending"
                      ...
                      : "✅ Booking confirmada. Revisa la informacion de acceso o PIN en el chat."}
                  </div>
                  <button
                    onClick={() => setChatRes(r)}
                    style={{
        ...
        {favorites.length === 0 ? (
          <div style={{ textAlign: "center", padding: "60px 24px" }}>
            ...
            <div style={{ color: T.textSub, fontSize: 14, lineHeight: 1.6 }}>
              Presiona el corazón en cualquier parqueo para guardarlo here.
            </div>
          </div>
        ) : (
          favorites.map((spot) => (
...
function SupportChatScreen({ onClose, reservationId }) {
  const [messages, setMessages] = useState([
    {
      id: 1,
      from: "support",
      text: "¡Hola! Soy el equipo de soporte de Parkealo. ¿En qué podemos ayudarte today?",
      time: "Ahora",
    },
  ]);
  const [input, setInput] = useState("");
  ...
  const CATEGORIES = [
    ...
    { key: "refund", label: "Request reembolso", icon: "💰" },
  ...
  const AUTO_REPLIES = {
    ...
    damage:
      "Lamentamos escuchar eso. Por favor envíanos fotos del daño. Activemos el seguro Parkealo automáticamente.",
    refund:
  ...
  return (
    ...
    >
          ...
          <>
            ...
            >
              ...
              <div style={{ fontSize: 11, color: T.warn, lineHeight: 1.6 }}>
                • Timestamped photos when possible{"\n"}• Capturas
                del chat con el host{"\n"}• Photo of your license plate along with the damage
              </div>
            </div>
            {/* Summary */}
            <Card>
      ...
      >
        ...
        >
          {step === 2 ? "Send reclamación" : "Continuar →"}
        </Btn>
      </div>
    </div>
  );
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "20px 16px" }}>
        ...
        <Card style={{ marginBottom: 16 }}>
          ...
          {[
            ...
            ["3", "Ambos ganan RD$50 al agor su primera reserva", "🎁"],
          ].map(([n, txt, icon]) => (
            <div
              key={n}
              style={{
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "16px 14px" }}>
          ...
          <div>
            ...
            {expandedPriv && (
              ...
              >
                ...
                Parkealo collects: name, email, vehicle license plate, location
                (only during active bookings) and transaction history.
                This data is used exclusively to: process bookings,
                improve the service and comply with legal requirements. Nunca
        ...
        {/* Support options */}
        <Card style={{ marginBottom: 14 }}>
          <SectionLabel>Help y soporte</SectionLabel>
          {[
            {
              icon: "🎧",
        ...
        <Card>
          ...
          {[
            { icon: "🗑️", label: "Delete mi cuenta", color: T.danger },
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            <div style={{ color: "#fff", fontWeight: 900, fontSize: 17 }}>
              {existing ? "Edit vehículo" : "Agregar vehículo"}
            </div>
            <div style={{ color: "rgba(255,255,255,0.65)", fontSize: 12 }}>
...
function AccountScreen({ user, onLogout, lang = "en", setLang }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "16px 14px" }}>
        {tab === "profile" && (
          <Card>
              ...
              {editing ? (
                ...
                <div
                  style={{
                    padding: "11px 12px",
                    background: T.surface,
                    border: `1.5px solid ${licensePlate ? T.blueMid : T.border}`,
                    borderRadius: 10,
                    display: "flex",
                    alignItems: "center",
                    gap: 10,
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke={licensePlate ? T.blue : T.textFaint}
                    strokeWidth="2"
                    strokeLinecap="round"
                  >
                    <rect x="1" y="3" width="22" height="18" rx="2" />
                  ...
                  <span
                    style={{
                      fontSize: 14,
                      fontWeight: licensePlate ? 700 : 400,
                      color: licensePlate ? T.text : T.textFaint,
                      letterSpacing: licensePlate ? 1 : 0,
                    }}
                  >
                    {licensePlate || "No license plate registered"}
                  </span>
                  {licensePlate && (
                    <Tag
                      color={T.blue}
            ...
            {[
              ...
              { l: "Notifications", icon: "🔔", action: null },
            ].map((item) => (
              <div
                key={item.l}
                onClick={item.action || undefined}
        ...
        {tab === "payments" && (
          <>
            <SectionLabel>Methods de pago guardados</SectionLabel>
            {CARDS.map((card) => (
              <div
                key={card.id}
                style={{
            ...
            <SectionLabel>New tarjeta</SectionLabel>
            <Card>
              {[
...
function ParkingSpaceManager({ unitPricing }) {
  ...
  const statusLabel = (st) => (st === "occupied" ? "Occupied" : "Libre");
  return (
    <div>
      {sections.map((sec) => {
...
function AmenitiesEditor() {
  const ALL_AMENITIES = [
    {
      ...
      label: "Covered",
      icon: "🏠",
      desc: "Area cubierta / techo",
    },
    { key: "ev", label: "Carga EV", icon: "⚡", desc: "Cargadores eléctricos" },
    { key: "cameras", label: "Cameras", icon: "📹", desc: "Vigilancia 24h" },
    ...
    },
    {
      ...
      label: "Motos",
      icon: "🏍️",
      desc: "Area para motocicletas",
    },
    {
      key: "restroom",
      label: "Baños",
      icon: "🚻",
      desc: "Services sanitarios",
    },
  ];
  ...
  return (
    <div>
      ...
      {/* Amenity toggles */}
      <Card style={{ marginBottom: 14 }}>
        <SectionLabel>Services del parqueo</SectionLabel>
  ...
  return (
    <div>
      ...
      {saved ? (
        ...
        >
          <span style={{ color: T.green, fontWeight: 800, fontSize: 14 }}>
            ✓ Prices guardados correctamente
          </span>
        </div>
      ) : (
        <Btn
...
function OwnerDashboard() {
  ...
  const notifs = [
    {
      msg: "User A123456 terminó su tiempo en espacio B1",
      t: "ago 5 min",
      acc: T.warn,
    },
    {
      msg: "New solicitud privada — licensePlate C789012",
      t: "ago 18 min",
      acc: T.blue,
    },
    {
    ...
    {
      msg: "Booking confirmada — D901234 · tomorrow 09:00",
      t: "ago 1h",
      acc: T.green,
    },
  ];
  return (
    ...
    >
      ...
      {showParkingQR && (
        <ParkingQRModal
          parking={{ id: "COL001", name: "Parking Colonial Premium" }}
      ...
      {!publishedParking ? (
        ...
        >
          ...
          >
            Publica tu primer parqueo y empieza a recibir reservas today mismo. El
              ...
              <>
                ...
                >
                  {[
                    ...
                    { l: "Bookingtions today", v: "14", c: T.warn, bd: T.warn },
    ...
    >
      ...
      >
        ...
        <Card style={{ marginBottom: 14 }}>
          ...
          >
            <SectionLabel style={{ margin: 0 }}>Account de retiro</SectionLabel>
            <button
        ...
        <Card>
          ...
          {[
            {
              desc: "Booking A3 · Carlos M.",
              amount: "+RD$300",
              date: "Hoy 10:30",
              c: T.green,
            },
            {
              desc: "Booking B1 · María G.",
              amount: "+RD$150",
              date: "Hoy 09:00",
              c: T.green,
            },
        ...
        {step === 0 && (
          <>
            <FInput
              ...
              placeholder="Ej: Parking Central o Casa de Juan"
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <button
                onClick={() => {
                  set("gpsUsed", true);
                  set("address", "Street Las Damas 23, Zone Colonial");
                  set("lat", "18.4742");
                  set("lng", "-69.8923");
                }}
                style={{
              ...
              >
                ...
                <div style={{ textAlign: "left" }}>
                  ...
                  <div style={{ fontSize: 11, color: T.textSub }}>
                    {form.gpsUsed
                      ? form.address
                      : "Active el GPS para mayor precisión"}
                  </div>
                </div>
              </button>
              {/* Drop-pin mock map */}
              ...
              <FInput
                ...
                placeholder="Street, número, edificio..."
...
const INITIAL_DISPUTES = [
  {
    ...
    host: { name: "J. Martínez", parking: "Parking Colonial Premium" },
    amount: "RD$300",
    created: "Hace 1h",
  ...
  },
  {
    ...
    description:
      "Se me cobró un sobretiempo de 34 minutos pero salí withinl tiempo reservado. Tengo foto del ticket de salida.",
    ...
    return (
      ...
      >
        ...
        <div style={{ padding: "14px 14px" }}>
          ...
          {/* Description */}
          <Card style={{ marginBottom: 12 }}>
            <SectionLabel>Description del usuario</SectionLabel>
            <div
              style={{
                background: T.surface,
                borderRadius: 12,
          ...
          {/* Timeline */}
          <Card style={{ marginBottom: 12 }}>
            <SectionLabel>History del caso</SectionLabel>
            <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
              {d.timeline.map((e, i) => {
                const colors = {
                  user: T.blue,
          ...
          {d.status !== "resolved" && (
            <Card>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {[
                  {
                    label: "Request evidencia al usuario",
                    icon: "📎",
                    action: () => {
                      setReplyText(
...
function AdminSupportPanel() {
  ...
  const ROLE_LABELS = { user: "User", host: "Host", admin: "Support" };
  const CAT_LABELS = {
    reservation: "Booking",
    payment: "Pago",
    damage: "Daño",
    ...
    <div>
      ...
      {activeSection === "overview" && (
        <>
          ...
          {/* Top makes */}
          <Card style={{ marginBottom: 14 }}>
            <SectionLabel>Makes más populares</SectionLabel>
      ...
      {activeSection === "activity" && (
        <>
          <Card style={{ marginBottom: 14 }}>
            <SectionLabel>Vehicles más activos</SectionLabel>
            {topActive.map((v, i) => (
              <div
                key={i}
                style={{
          ...
          <Card style={{ marginBottom: 14 }}>
            <SectionLabel>Vehicles nuevos (últimas semanas)</SectionLabel>
            {newest.map((v, i) => (
              <div
                key={i}
                style={{
          ...
          <Card>
            ...
            {[
              ...
              {
                icon: "📅",
                label: "Year promedio de la flota",
                value: "2020",
                sub: "Flota relativamente nueva",
              },
              {
                icon: "⚡",
                label: "User más activo",
                value: "Carmen Díaz",
...
function AdminPanel() {
  ...
  const HOT_ZONES = [
    { zone: "Zone Colonial", res: 312, pct: 28 },
  ...
  const FILTERS_USED = [
    { label: "Covered", count: 4820, pct: 31 },
    { label: "24/7", count: 3940, pct: 25 },
    { label: "Cameras", count: 3120, pct: 20 },
    { label: "Carga EV", count: 2280, pct: 15 },
    { label: "Valet", count: 1400, pct: 9 },
  ];
  const PAYMENT_METHODS = [
    { label: "Card", pct: 62, color: T.blue },
    { label: "Cash", pct: 28, color: T.warn },
      ...
      <div style={{ padding: "14px 14px" }}>
        ...
        {tab === "overview" && (
          <>
            ...
            <Card>
              <SectionLabel>Parkings registrados</SectionLabel>
              {SPOTS.map((s) => (
                <div
                  key={s.id}
                  style={{
          ...
          <>
            ...
            <Card style={{ marginBottom: 14 }}>
              ...
              {[
                ...
                ["Bookingn al menos 1 vez/semana", "61%", T.blue],
        ...
        {tab === "finance" && (
          <>
            ...
            <Card>
              <SectionLabel>Methods de pago</SectionLabel>
              <div
                style={{
                  display: "flex",
                  gap: 3,
        ...
        {tab === "parking" && (
          <>
            <Card style={{ marginBottom: 14 }}>
              <SectionLabel>🔥 Zones más activas</SectionLabel>
              {HOT_ZONES.map((z, i) => (
                <StatRow
                  key={i}
                  label={z.zone}
            ...
            <Card style={{ marginBottom: 14 }}>
              <SectionLabel>Parkings más ocupados</SectionLabel>
              {TOP_SPOTS.map((s, i) => (
                <div
                  key={i}
                  style={{
        ...
        {tab === "behavior" && (
          <>
            ...
            <Card style={{ marginBottom: 14 }}>
              <SectionLabel>Duration de estadía más reservada</SectionLabel>
              {[
                ["1 hora", "38%", T.blue, 38],
            ...
            <Card style={{ marginBottom: 14 }}>
              <SectionLabel>Destinations más buscados</SectionLabel>
              {[
            ...
            <Card style={{ marginBottom: 14 }}>
              ...
              {[
                ["Bookingtions automáticas aceptadas", "74%", T.green],
                ["Bookingtions manuales aprobadas", "21%", T.blue],
                ["Bookingtions canceladas", "5%", T.danger],
                ["Users que extienden tiempo", "22%", T.warn],
                ["Users que usan chat con host", "38%", T.blueNav],
                ["Bookingtions con microseguro activo", "61%", T.green],
...
function LoginScreen({ onLogin }) {
  ...
  const handleSignup = () => {
    ...
    if (!validateEmail(email)) {
      setError("Email address inválido.");
      return;
    }
...
function ParkingQRModal({ parking, onClose }) {
  ...
  const qrName = parking?.name || "Parking Colonial Premium";
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Escanea con la app Parkealo o tu cámara para agor check-in o
          ...
          >
            ...
            <div style={{ fontSize: 11, color: T.textSub, lineHeight: 1.6 }}>
              • User con reserva → activa el reloj • Sin cuenta → descarga la
...
function QRScanResult({ type, parkingName, onClose }) {
      ...
      >
        ...
        >
          ...
          <div style={{ color: "rgba(255,255,255,0.7)", fontSize: 12 }}>
            Download Parkealo to reserve this spot and check-in
          </div>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            <span style={{ fontSize: 20 }}>🍎</span> Download en App Store
          </button>
          <button
            style={{
              background: "rgba(255,255,255,0.15)",
          ...
          >
            <span style={{ fontSize: 20 }}>🤖</span> Download en Google Play
          </button>
        </div>
        <button
          onClick={onClose}
  ...
  return (
    ...
    >
      ...
      >
        This QR code belongs to <strong>{parkingName}</strong>. You don't have
        none active booking in this parking.
      </div>
      <button
        onClick={onClose}
        style={{
...
export default function App() {
  ...
  const renderContent = () => {
    ...
    if (tab === "reservations") return <BookingtionsScreen />;
    if (tab === "favorites")
      return (
        <FavoritesScreen
          favorites={favorites}
