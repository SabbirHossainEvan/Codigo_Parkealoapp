        ...
        <div style={{ padding: "18px 16px 0" }}>
            ...
            <Toggle
              ...
              sub={
                ...
                <span>
                  ...
                  Protegido con <strong>Seguros Reservations</strong> · Cubre hasta
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            {[
              ...
              ...(insurance ? [["Seguro Reservations", `${spot.currency}25`]] : []),
      ...
      if (isPublic) {
        ...
        if (hasSpaceSame) {
          ...
          setDiff({
            ...
            amenities: ["Covered", "Cameras", "Personal"],
        ...
        setDiff({
          ...
          note: "Parking cercano en el área — disponible ahora",
    ...
    >
      ...
      >
        ...
        >
          ...
          {existing ? "Save cambios" : "Agregar vehículo"}
...
function AccountScreen({ user, onLogout, lang = "es", setLang }) {
  ...
  const [placa, setLicense Plate] = useState("");
              ...
              {editing ? (
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) => setLicense Plate(e.target.value.toUpperCase())}
              ...
              <>
                ...
                >
                  ...
                  {[
                    ...
                    { l: "Reservations hoy", v: "14", c: T.warn, bd: T.warn },
          ...
          <>
            ...
            <Card style={{ marginBottom: 14 }}>
              ...
              {[
                ...
                ["Reservations automáticas aceptadas", "74%", T.green],

                ["Reservations manuales aprobadas", "21%", T.blue],

                ["Reservations canceladas", "5%", T.danger],

                ["Users que extienden tiempo", "22%", T.warn],

                ["Users que usan chat con host", "38%", T.blueNav],

                ["Reservations con microseguro activo", "61%", T.green],
  ...
  return (
    ...
    >
      ...
      >
        ...
        This QR code belongs to <strong>{parkingName}</strong>. No tienes
